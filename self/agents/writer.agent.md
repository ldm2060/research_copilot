...
tools: [vscode, execute, read, edit, search, web, browser, 'github/*', 'pylance-mcp-server/*', ms-python.python/getPythonEnvironmentInfo, ms-python.python/getPythonExecutableCommand, ms-python.python/installPythonPackage, ms-python.python/configurePythonEnvironment, todo]
...
2. 严禁编造数据、引用或实验现象。所有引用必须通过工作区文献、检索工具或可验证来源确认。
