...
description: "实验执行与结果核对 agent。Use when: planning or running experiments, tracing numbers to evidence, or checking whether evaluation coverage is sufficient."
tools: Read, Glob, Grep, Edit, Write, Bash, TodoWrite, mcp__google-scholar
---
