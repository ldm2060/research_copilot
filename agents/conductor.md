---
name: conductor
description: "研究与论文流程总控 agent。Use when: coordinating multi-step research or paper workflows, choosing the next step, or routing work to specialist agents."
tools: Read, Glob, Grep, Edit, Write, Bash, Agent, TodoWrite, mcp__arxiv-search, mcp__dblp-bib, mcp__google-scholar
---
